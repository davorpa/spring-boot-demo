...
public class ErrorAttributesCustomizerProperties
{
    ...
    /**
     * Configuration properties used to set up the request correlation error
     * attribute.
     *
     * @see io.davorpatech.fwk.web.request.correlation.errorattr.CorrelationErrorAttributeAdder
     *      CorrelationErrorAttributeAdder
     */
    private final Customizer correlation = new Customizer(100, "correlation");
    ...
    /**
     * Gets the configuration properties used to set up the request correlation
     * error attribute customizer.
     *
     * @return the request correlation error attribute customizer configuration
     *         properties
     */
    public Customizer getCorrelation()
    {
        return correlation;
    }
